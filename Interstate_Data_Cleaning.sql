...
CREATE TABLE interstate_with_weather AS SELECT * FROM
    interstate; -- Copy the current interstate table 
...
truncate table interstate;

INSERT INTO interstate
SELECT holiday, columbus, veterans, thanksgiving, christmas, new_year, 
washington, memorial, indep, state_fair, labor, MLK, temp, rain_1h, snow_1h, 
clouds_all, date_time, traffic_volume
FROM interstate_with_weather
GROUP BY holiday, columbus, veterans, thanksgiving, christmas, new_year, 
washington, memorial, indep, state_fair, labor, MLK, temp, rain_1h, snow_1h, 
clouds_all, date_time, traffic_volume; -- Obtain a new interstate table
...
# Note: interstate will be the data set to analyze.
